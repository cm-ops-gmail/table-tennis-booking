...
| Booking cancelled | Owner cancels | Updates that Calendar event's description to matching "cancelled" wording, then deletes it — Calendar's own cancellation notice to the guests carries that text. Line managers and HR get a "cancelled" email, same grouping as above. |
